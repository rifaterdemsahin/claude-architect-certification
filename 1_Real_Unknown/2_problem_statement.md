...
| 2 | Model Context Protocol (MCP) | `5_Symbols/course_src/module-2-mcp-server/` (deployed on Fly.io) |
| 3 | Zero-Data Retention (ZDR) & VPC Isolation | `5_Symbols/templates/aws-bedrock-private-link.tf` |
| 4 | Deterministic Routers & Circuit Breakers | `5_Symbols/course_src/module-4-multi-agent/router.py` |
| 5 | Prompt Caching & Cost Optimization | `5_Symbols/course_src/module-5-optimization/cache_layer.py` |
