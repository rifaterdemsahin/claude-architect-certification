# Spec: Customer Development Process | Claude AI Certification

> 🔖 **Version**: `0.1`
> 📐 **Versioning rule** — `0.1` initial · `0.11` small update · `0.2` bigger update. Bump manually when you edit this spec.

## 📍 Path
`./5_Symbols/production/preprod/customer_development.html`

## 🎯 Purpose & Rationale
**Description**: Detailed explanation of the Customer Development Process for the Personal Brand & AI Certification Course.

*Rationale*: This file exists to serve as the `Customer Development Process | Claude AI Certification` page for the project. Its primary goal is to provide the UI and functionality described in the description above. It is placed in `./5_Symbols/production/preprod` following the 7-stage folder structure framework.
...
### 4. Key Headings
- H1: Personal Brand Customer Development
- H2: 1 Customer Discovery 📍 ACTIVE STAGE
- H2: 2 Customer Validation
- H2: 3 Customer Creation
- H2: 4 Company Building
