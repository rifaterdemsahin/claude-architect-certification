...
### 4. Key Headings
- H1: The recording is the process. Everything else is set dressing.
- H2: Two loops, one reward
- H2: Demonstration or transfer
- H2: Whose fantasy
- H2: Pre-production has no bottom
- H2: The instrument
- H2: The forcing function
