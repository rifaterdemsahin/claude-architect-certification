...
- Functions: closeAllTabs, collectInternalPages, escHtml, filterPages, openAllPages, openGroup, renderSections, showToast
- Constants/Variables: SECTIONS, closed, cls, container, div, filtered, href, isExternal, label, lf
