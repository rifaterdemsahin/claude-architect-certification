# Spec: Ways of Working | Claude AI Certification

> 🔖 **Version**: `0.1`
> 📐 **Versioning rule** — `0.1` initial · `0.11` small update · `0.2` bigger update. Bump manually when you edit this spec.

## 📍 Path
`./5_Symbols/production/preprod/ways_of_working.html`

## 🎯 Purpose & Rationale
**Description**: Ways of working for content planning, table reading, and real-time AI image generation.

*Rationale*: This file exists to serve as the `Ways of Working | Claude AI Certification` page for the project. Its primary goal is to provide the UI and functionality described in the description above. It is placed in `./5_Symbols/production/preprod` following the 7-stage folder structure framework.
...
### 4. Key Headings
- H1: 🎨 Visual Script Table Read Method
- H2: 📖 The "Create Right, Paste Left, Read Out Loud" Loop
- H3: Read Out Loud
- H3: Create on Right
- H3: Paste on Left
