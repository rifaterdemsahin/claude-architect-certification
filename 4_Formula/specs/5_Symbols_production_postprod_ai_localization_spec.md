# Spec: AI Localization & Dubbing | Claude AI Certification

> 🔖 **Version**: `0.1`
> 📐 **Versioning rule** — `0.1` initial · `0.11` small update · `0.2` bigger update. Bump manually when you edit this spec.

## 📍 Path
`./5_Symbols/production/postprod/ai_localization.html`

## 🎯 Purpose & Rationale
**Description**: Track multi-language translation and voice-cloned dubbing per sentence and language, saved to Supabase.

*Rationale*: This file exists to serve as the `AI Localization & Dubbing | Claude AI Certification` page for the project. Its primary goal is to provide the UI and functionality described in the description above. It is placed in `./5_Symbols/production/postprod` following the 7-stage folder structure framework.
...
### 4. Key Headings
- H1: 🌍 AI Localization & Multi-Language Dubbing
