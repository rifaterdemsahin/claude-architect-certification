# Spec: AI Script & Prompt Generation | Claude AI Certification

> 🔖 **Version**: `0.1`
> 📐 **Versioning rule** — `0.1` initial · `0.11` small update · `0.2` bigger update. Bump manually when you edit this spec.

## 📍 Path
`./5_Symbols/production/postprod/ai_script_gen.html`

## 🎯 Purpose & Rationale
**Description**: Track LLM-generated sentences from source blueprints — model, source, prompt, output, and status, saved to Supabase.

*Rationale*: This file exists to serve as the `AI Script & Prompt Generation | Claude AI Certification` page for the project. Its primary goal is to provide the UI and functionality described in the description above. It is placed in `./5_Symbols/production/postprod` following the 7-stage folder structure framework.
...
### 4. Key Headings
- H1: ✍️ AI Script & Prompt Engineering
