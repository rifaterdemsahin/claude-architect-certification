...
- Functions: applyVideoFilter, defaultFilename, deleteFile, initVideoFilter, linkAssetToSentence, linkAssetToVideo, loadList, loadNote, loadSupabaseData, newNote, renderRelationsMarkup, saveNote
- Constants/Variables: CONTAINER, SUPABASE_ANON, SUPABASE_URL, active, banner, blob, card, client, container, content
