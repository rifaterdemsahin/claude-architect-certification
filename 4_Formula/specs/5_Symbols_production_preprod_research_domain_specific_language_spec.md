...
- Functions: searchRelated, loadEntries, toggleExpand, categoryEmoji, deleteEntry, toast, escHtml, renderList, editEntry, applyFilter
- Constants/Variables: map, relTerms, client, context, el, entry, term, source, SUPABASE_URL, definition
