# Spec: Post-Production | Claude AI Certification

> 🔖 **Version**: `0.1`
> 📐 **Versioning rule** — `0.1` initial · `0.11` small update · `0.2` bigger update. Bump manually when you edit this spec.

## 📍 Path
`./5_Symbols/production/postprod/index.html`

## 🎯 Purpose & Rationale
**Description**: Post-production scene review, overlays, lower thirds, and assets for the Claude AI Certification for Architects.

*Rationale*: This file exists to serve as the `Post-Production | Claude AI Certification` page for the project. Its primary goal is to provide the UI and functionality described in the description above. It is placed in `./5_Symbols/production/postprod` following the 7-stage folder structure framework.
