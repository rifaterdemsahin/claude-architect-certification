...
- Functions: barColor, esc, getJson, pct, run, showError
- Constants/Variables: H, IMG_CONTAINER, SUPABASE_ANON_KEY, SUPABASE_URL, anyCount, body, byScript, e, imgCount, imgEl
