...
- Functions: fetchLogs, filterLogs, formatDescription, getStatusIcon, parseLog, renderLogs, switchTab
- Constants/Variables: LOG_PATHS, altRegex, body, entries, errText, filtered, fixText, icons, lines, list
