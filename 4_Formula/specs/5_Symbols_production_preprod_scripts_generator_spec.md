...
- Functions: copyToClipboard, generateScript, setTemplate, updateVideos
- Constants/Variables: MODULE_DATA, TEMPLATES, modId, modName, status, textarea, vidId, vidName, vidSelect, videos
