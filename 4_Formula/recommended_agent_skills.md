...
## 1. 🕸️ Broken Link & Asset Crawler (`link-crawler`)
...
## 2. 📝 HTML Spec Auto-Generator (`generate-html-specs`)
...
## 3. 🚦 Build & Syntax Gate (`build-gate`)
...
## 4. 🗄️ Supabase Schema Synchronizer (`db-sync`)
...
## 5. 🎬 Lower-Thirds Asset Pipeline (`generate-lower-thirds`)
