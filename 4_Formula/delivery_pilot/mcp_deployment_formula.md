...
> **Related files:** `.github/workflows/test_mcp.yml`, `5_Symbols/course_src/module-2-mcp-server/fly.toml`, `5_Symbols/course_src/module-2-mcp-server/mcp.config.json`
...
**Current equivalent:** `5_Symbols/course_src/module-2-mcp-server/fly.toml`
...
| `fly.toml` | `5_Symbols/course_src/module-2-mcp-server/` | Runtime topology — VM, region, ports |
| `mcp.config.json` | `5_Symbols/course_src/module-2-mcp-server/` | Tool definitions for Claude client |
| `deploy.sh` | `5_Symbols/course_src/module-2-mcp-server/` | One-command `fly deploy` wrapper |
...
| How do I test locally? | `npm start` or `npm run build` in `5_Symbols/course_src/module-2-mcp-server/` |
...
- 📁 `5_Symbols/course_src/module-2-mcp-server/README.md` — MCP server implementation details
- 📁 `.github/workflows/test_mcp.yml` — current CI workflow
- 📁 `5_Symbols/course_src/module-2-mcp-server/fly.toml` — current Fly.io topology
