...
('Pre-Production', 'Scripts finalized',             'Per-section scripts approved and uploaded',                                     20, 'scripts/index.html'),
('Pre-Production', 'Storyboard / scene breakdown',  'Scene list with timing and overlays defined',                                   30, '../../../../markdown_renderer.html?file=4_Formula/delivery_pilot/implementation_guide.md'),
...
('Pre-Production', 'Lower third designs approved',  'Per-module L3 variants signed off',                                             60, '../postprod/production_shotlist.html'),
('Pre-Production', 'Production plan reviewed',      'Master plan read by all stakeholders',                                          70, '../../../../markdown_renderer.html?file=4_Formula/delivery_pilot/implementation_guide.md');

-- Production (7 items)
INSERT INTO checklist_items (phase, item_name, item_desc, sort_order, item_url) VALUES
('Production', 'Audio recorded per section',        'moduleX_sectionY.wav files captured',                                          10, '../prod/index.html'),
...
('Production', 'Raw assets archived',               'Original recordings backed up before editing',                                  30, '../prod/index.html'),
('Production', 'Screen recordings captured',        'IDE / dashboard walkthroughs recorded',                                         40, '../prod/index.html'),
('Production', 'Camera footage backed up',          'All video sources copied to storage',                                           50, '../prod/index.html'),
...
INSERT INTO checklist_items (phase, item_name, item_desc, sort_order, item_url) VALUES
('Post-Production', 'Background images generated',  'All scene backgrounds created and named correctly',                             10, '../postprod/index.html'),
('Post-Production', 'Text overlays generated',      'Typography overlays match script emphasis',                                     20, '../postprod/index.html'),
('Post-Production', 'Icons generated',              'All cue icons created in correct style',                                        30, '../postprod/index.html'),
('Post-Production', 'Lower thirds rendered',        'All L3 assets exported with transparency',                                      40, '../postprod/production_shotlist.html'),
('Post-Production', 'EDL reviewed for each scene',  'Edit design lists match audio waveform',                                        50, '../postprod/production_shotlist.html'),
('Post-Production', 'Composite previews checked',   'Hover previews match intended final look',                                      60, '../postprod/module-1/section-1/asset_checklist.html'),
('Post-Production', 'Asset bundles zipped',         'Per-scene ZIP files ready for editor handoff',                                  70, '../postprod/index.html'),
('Post-Production', 'Final render approved',        'Master video exported and reviewed',                                            80, '../postprod/index.html'),
...
('Publication', 'Modules 2–5 set to members-only', '$10/month join tier to access full course content',                              90, '../publish/membership.html'),
('Publication', 'Pricing page live',                '$10/mo membership page with feature breakdown',                                100, '../publish/membership.html'),
